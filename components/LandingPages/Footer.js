...
export default function Footer() {
    ...
    return (
        <>
            <div className="pai-cta">
                <Container>
                    <div className="cta-section">
                        <Row className="align-items-center">
                            <Col lg={7} >
                                <h3 className="cta-title" data-aos="fade-right" data-aos-duration="500" data-aos-once="true">Get started by downloading apps.</h3>
                            </Col>
                            <Col lg={5}>
                                <div className="cta-button-container text-center text-lg-end">
                                    <Button variant="primary" className="cta-button" data-aos="fade-left" data-aos-duration="500" data-aos-once="true">Sign up today!</Button>
                                </div>
                            </Col>
                        </Row>
                    </div>
                        ...
                        <Row>
                            <Col lg={4} md={8} xs={10}>
                                <div className="footer-widget">
                                    ...
                                    <p className="footer-text">Postrai is an easy to use ai tool, to help you label your images. We at Postrai strive everyday to make sure our ai is the best for your images.</p>
                                </div>
                            </Col>
                            <Col lg={8}>
                                <Row>
