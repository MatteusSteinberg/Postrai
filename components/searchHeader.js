...
export default function SearchHeader({ children, title }) {
    ...
    return (
        <Container className="seachHeaderContainer">
            <Row className="seachHeaderRow">
                <Col lg={12}>
                    <div className="pai-browse-inner">
                        {children}
                        <div className="pai-browse-search">
                            <Form className="pai-browse-form">
                                <Form.Group className="form-group" controlId="formBasicText">
                                    <Form.Control className="pai-browse-input" type="text" placeholder="Search free high-resoluton photos" onKeyDown={handleSearch} ref={searchInput} />
                        ...
                        <div className="pai-browse-trends">
                            <div className="pai-browse-trends-list">
                                <ul className="trends">
